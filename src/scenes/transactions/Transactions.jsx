...
const Transactions = () => {
  ...
  return (
    <div className="w-2/5 h-72 overflow-auto scrollbar-hide">
          ...
          <tbody key={i}>
            <tr className="text-center bg-slate-700">
              ...
              <td className="border-red-700"> 
                <div className="p-1 rounded-xl bg-emerald-500 text-white">$ {transaction.cost}</div>
              </td>
              <td className="text-gray-200 border-red-800">{transaction.date}</td>
            </tr>
          </tbody>
        ))}
      </table>
